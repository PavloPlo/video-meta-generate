import type { HOOK_TONES, READABILITY_LEVELS, ALERT_KINDS, ALERT_SCOPES, THUMBNAIL_SOURCE_TYPES } from '@/constants/video';

export type HookTone = typeof HOOK_TONES[keyof typeof HOOK_TONES];
export type Readability = typeof READABILITY_LEVELS[keyof typeof READABILITY_LEVELS];
...
export type SourceType = typeof THUMBNAIL_SOURCE_TYPES[keyof typeof THUMBNAIL_SOURCE_TYPES];
